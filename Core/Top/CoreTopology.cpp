...
//#include <Core/Top/CorePacketsAc.hpp>
...
Svc::Health::PingEntry pingEntries[] = {
    ...
    {PingEntries::Core_eventLogger::WARN, PingEntries::Core_eventLogger::FATAL, "eventLogger"},
    {PingEntries::Core_fileDownlink::WARN, PingEntries::Core_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::Core_fileManager::WARN, PingEntries::Core_fileManager::FATAL, "fileManager"},
    {PingEntries::Core_fileUplink::WARN, PingEntries::Core_fileUplink::FATAL, "fileUplink"},
    {PingEntries::Core_prmDb::WARN, PingEntries::Core_prmDb::FATAL, "prmDb"},
    {PingEntries::Core_rateGroup1::WARN, PingEntries::Core_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::Core_rateGroup2::WARN, PingEntries::Core_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::Core_rateGroup3::WARN, PingEntries::Core_rateGroup3::FATAL, "rateGroup3"},
};
...
void configureTopology() {
    ...
    // Note: Uncomment when using Svc:TlmPacketizer
    // tlmSend.setPacketList(CorePacketsPkts, CorePacketsIgnore, 1);
...
// Public functions for use in main program are namespaced with deployment name Core
namespace Core {
