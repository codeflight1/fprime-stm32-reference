// ======================================================================
// \title  CoreTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef CORE_CORETOPOLOGY_HPP
#define CORE_CORETOPOLOGY_HPP
// Included for access to Core::TopologyState and Core::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <Core/Top/CoreTopologyDefs.hpp>

// Remove unnecessary Core:: qualifications
 ...
 * Core::TopologyState see: CoreTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type Core::TopologyState see: CoreTopologyDefs.hpp.
 *
